...
public class DtoUtils {
    ...
    protected static InventoryData convertInventoryPojoToData(String product, InventoryPojo inventoryPojo){
    ...
    protected static InventoryPojo convertInventoryFormToPojo(InventoryForm inventoryForm){
    ...
    protected static InventoryData convertInventoryPojoToData(InventoryPojo inventoryPojo){
        InventoryData inventoryData = new InventoryData();
        inventoryData.setBarcode(inventoryPojo.getBarcode());
        inventoryData.setQuantity(inventoryPojo.getQuantity());
        inventoryData.setProduct(inventoryPojo.getProduct());
